...
const AllPlace = [
    {
        kerala: [
            ...
            },
            {
                ...
                duration: 'Munnar 2N, Thekkady 1N, Alleppey 1N, Kovalam 1N, Kochi 1N',
                price: '28,099',
            },
        ],
        shirdi: [
        ...
        vietnam: [
            {
                ...
                img: viatnam,
                banner: viatnam3,
                description: 'This tour is designed for Indian travelers seeking a complete Vietnam experience. The tour covers stay at 3/4 star hotels.(Hotels Offered are 10-15 mins distance by walk from Indian Restaurants). All important sights in Vietnam are covered over a span of 6 days before returning back to India.',
                highlight: [
        ...
        bali: [
            {
                ...
                img: baliimg3,
                banner: balihome,
                description: 'A bestseller trip for first timers to Bali. It covers the most important sights in Bali over a period of 6 days. The deal has special airfares bundled with hotels and land excursions to sell. There are 2 days provided free where guests have time to indulge in activities on their own.',
                highlight: [
        ...
        andaman: [
            {
                ...
                img: andaman,
                banner: andamanhome,
                description: 'The Andaman and Nicobar Islands is a union territory of India consisting of 572 islands, of which 37 are inhabited, at the junction of the Bay of Bengal and the Andaman Sea.',
                highlight: [
