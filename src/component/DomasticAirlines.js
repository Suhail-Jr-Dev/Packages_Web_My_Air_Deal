        ...
        <div className="relative w-[100%] overflow-hidden">
          ...
          >
            {domasticData?.map((place, index) => (
              ...
              <div
                key={index}
                className="carousel-item  cursor-pointer hover:scale-105 transition-all duration-300 min-w-[300px] py-10 sm:min-w-[300px] lg:min-w-[350px] flex items-center justify-center"
              >
                <div
                  key={index}
