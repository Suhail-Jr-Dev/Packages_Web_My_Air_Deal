    ...
    return (
        <div className='flex items-center justify-center py-8'>
            <div className='w-full md:w-[95%]'>
                <h1 className=' md:text-[1.5rem] text-brandCol font-semibold text-[1.3rem]  py-5'>Popular Packages</h1>
                <div style={{ boxShadow: '0px 0px 3px 0.1px black' }} className='flex flex-wrap gap-5 bg-white p-3 py-5 rounded-lg justify-evenly'>
                    ...
                    {PopularFlights?.map((element, index) => (
                        ...
                        <div div key = { index } className = 'flex items-center gap-2 w-full sm:w-[48%] md:w-[30%] lg:w-[30%] p-2' >
                            <div className='flex items-center p-2 w-auto'>
                                <img src={element?.img} alt="" className='w-[3rem] h-[3rem] md:w-[3.8vw] md:h-[3vw] rounded-full' />
                            </div>
